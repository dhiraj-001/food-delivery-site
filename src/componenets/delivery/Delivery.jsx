...
export default function Delivery() {
  return (
    <div>
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 delivery-main lg:px-8 ">
        <div className="relative isolate overflow-hidden delivery bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <svg
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">        
            <h2 className="text-3xl del-head font-bold tracking-tight text-white sm:text-4xl">
              <p>
                Get Your Order 24/7 
              </p>
              <p>
