        ...
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-full p-8 m-auto backdrop-blur-3xl rounded-md shadow-xl lg:max-w-xl shd ">
                ...
                <form className="mt-6">
                    ...
                    <div className="mt-6">
                        <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600 merienda-1">
                            Login
                        </button>
                    </div>
                </form>
